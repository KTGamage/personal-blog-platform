        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <span className="text-xl font-bold text-gray-800 dark:text-white">BlogPlatform</span>
            </Link>
              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    ...
                    <svg 
                      className={`w-4 h-4 text-gray-500 dark:text-gray-400 transition-transform ${isProfileMenuOpen ? 'rotate-180' : ''}`}
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
