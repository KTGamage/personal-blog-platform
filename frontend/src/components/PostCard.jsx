...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="card p-6 lift-on-hover h-full flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm dark:shadow-gray-900/20 transition-all duration-300">
      {/* Cover Image */}
      {post.coverImage && (
      ...
      {/* Title */}
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3 line-clamp-2 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700 mt-auto">
        ...
        <Link
          to={`/post/${post._id}`}
          className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium text-sm transition-colors duration-200 flex items-center space-x-1"
        >
          <span>Read more</span>
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
